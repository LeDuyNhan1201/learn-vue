...
export function useCreateTaskMutation() {
  return useMutation<CreateTaskResponse, UnauthenticatedErrorResponse, CreateTaskRequest>({
...
export function useUpdateTaskMutation() {
  return useMutation<
    ...
    { taskId: TaskIdPathParam; body: UpdateTaskRequest }
  >({
    mutationKey: ["task", "update"],
    mutationFn: ({ body, taskId }) => updateTask(body, taskId),
    onSuccess: async () => {},
    onError(error) {
      if (isAxiosError(error)) {
...
export function useUpdateTaskStatusMutation() {
  return useMutation<UpdateTaskResponse, UnauthenticatedErrorResponse, UpdateTaskStatusRequest>({
...
export function useDeleteTaskMutation() {
  return useMutation<DeleteTaskResponse, UnauthenticatedErrorResponse, TaskIdPathParam>({
